    ...
    public class ArtistController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Artists != null ? 
                          ...
                          Problem("Entity set 'MyTunesContext.Artists'  is null.");
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var songs = from s in _context.Songs
                        select s;
            songs = songs.Where(s=>s.ArtistId.Equals(id));
            var artistSongs = new ArtistSongsModel{
                Artist = artist,
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MyTunesContext.Artists'  is null.");
            }
            var artist = await _context.Artists.FindAsync(id);
            if (artist != null)
            {
