...
namespace MyTunes.Controllers
{
    public class SongsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,ArtistId, Price")] Song song)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,ArtistId, Price")] Song song)
        {
            if (id != song.Id)
            {
                return NotFound();
